...
class EnergyHatchUnbakedModel : UnbakedModel {
    ...
    companion object {
        ...
        val OVERLAY_INPUT = Identifier("block/ports/overlay_energy_hatch_input")
        val OVERLAY_OUTPUT = Identifier("block/ports/overlay_energy_hatch_output")
