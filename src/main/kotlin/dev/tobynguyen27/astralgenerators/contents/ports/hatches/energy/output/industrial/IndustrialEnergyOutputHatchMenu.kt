...
class IndustrialEnergyOutputHatchMenu(
    syncId: Int,
    playerInventory: Inventory,
    val ctx: ContainerLevelAccess,
) : MachineGUI(AGMenus.INDUSTRIAL_ENERGY_OUTPUT_HATCH, syncId, playerInventory, null, null) {
    ...
    companion object {
        const val ID = "industrial_energy_output_hatch_menu"
    }
