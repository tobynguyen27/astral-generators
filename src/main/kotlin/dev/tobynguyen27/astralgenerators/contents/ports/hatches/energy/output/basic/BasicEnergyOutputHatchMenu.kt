...
class BasicEnergyOutputHatchMenu(
    syncId: Int,
    playerInventory: Inventory,
    val ctx: ContainerLevelAccess,
) : SyncedGuiDescription(AGMenus.BASIC_ENERGY_OUTPUT_HATCH, syncId, playerInventory, null, null) {
    ...
    companion object {
        const val ID = "basic_energy_output_hatch_menu"
    }
