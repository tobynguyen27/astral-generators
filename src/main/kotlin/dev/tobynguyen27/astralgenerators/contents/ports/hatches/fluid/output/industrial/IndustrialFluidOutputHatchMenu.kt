...
class IndustrialFluidOutputHatchMenu(
    syncId: Int,
    playerInventory: Inventory,
    val ctx: ContainerLevelAccess,
) : MachineGUI(AGMenus.INDUSTRIAL_FLUID_OUTPUT_HATCH, syncId, playerInventory, null, null) {
    ...
    companion object {
        const val ID = "industrial_fluid_output_hatch_menu"
    }
