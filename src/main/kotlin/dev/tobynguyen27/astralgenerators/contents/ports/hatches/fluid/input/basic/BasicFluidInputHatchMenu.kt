...
class BasicFluidInputHatchMenu(
    syncId: Int,
    playerInventory: Inventory,
    val ctx: ContainerLevelAccess,
) : SyncedGuiDescription(AGMenus.BASIC_FLUID_INPUT_HATCH, syncId, playerInventory, null, null) {
    ...
    companion object {
        const val ID = "basic_fluid_input_hatch_menu"
    }
