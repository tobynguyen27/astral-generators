...
class IndustrialEnergyInputHatchMenu(
    syncId: Int,
    playerInventory: Inventory,
    val ctx: ContainerLevelAccess,
) : MachineGUI(AGMenus.INDUSTRIAL_ENERGY_INPUT_HATCH, syncId, playerInventory, null, null) {
    ...
    companion object {
        const val ID = "industrial_energy_input_hatch_menu"
    }
