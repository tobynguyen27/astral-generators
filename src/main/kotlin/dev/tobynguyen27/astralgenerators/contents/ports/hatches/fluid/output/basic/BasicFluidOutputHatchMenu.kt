...
class BasicFluidOutputHatchMenu(
    syncId: Int,
    playerInventory: Inventory,
    val ctx: ContainerLevelAccess,
) : SyncedGuiDescription(AGMenus.BASIC_FLUID_OUTPUT_HATCH, syncId, playerInventory, null, null) {
    ...
    companion object {
        const val ID = "basic_fluid_output_hatch_menu"
    }
